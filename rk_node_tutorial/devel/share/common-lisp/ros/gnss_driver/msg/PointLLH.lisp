...
(cl:defmethod cl:initialize-instance :after ((m <PointLLH>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointLLH)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gnss_driver-msg:<PointLLH> is deprecated: use gnss_driver-msg:PointLLH instead.")))

(cl:ensure-generic-function 'lon-val :lambda-list '(m))
(cl:defmethod lon-val ((m <PointLLH>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:lon-val is deprecated.  Use gnss_driver-msg:lon instead.")
  (lon m))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <PointLLH>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:lat-val is deprecated.  Use gnss_driver-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <PointLLH>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:height-val is deprecated.  Use gnss_driver-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointLLH>)))
  ...
  (cl:format cl:nil "float64 lon~%float64 lat~%float64 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointLLH)))
  "Returns full string definition for message of type 'PointLLH"
  (cl:format cl:nil "float64 lon~%float64 lat~%float64 height~%~%~%"))
