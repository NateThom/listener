...
(cl:defmethod cl:initialize-instance :after ((m <Quaternion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Quaternion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gnss_driver-msg:<Quaternion> is deprecated: use gnss_driver-msg:Quaternion instead.")))

(cl:ensure-generic-function 'qx-val :lambda-list '(m))
(cl:defmethod qx-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:qx-val is deprecated.  Use gnss_driver-msg:qx instead.")
  (qx m))

(cl:ensure-generic-function 'qy-val :lambda-list '(m))
(cl:defmethod qy-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:qy-val is deprecated.  Use gnss_driver-msg:qy instead.")
  (qy m))

(cl:ensure-generic-function 'qz-val :lambda-list '(m))
(cl:defmethod qz-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:qz-val is deprecated.  Use gnss_driver-msg:qz instead.")
  (qz m))

(cl:ensure-generic-function 'qw-val :lambda-list '(m))
(cl:defmethod qw-val ((m <Quaternion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnss_driver-msg:qw-val is deprecated.  Use gnss_driver-msg:qw instead.")
  (qw m))
